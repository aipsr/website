...
\pretitle{\begin{flushleft}\color{redesteal}\rule{\linewidth}{1.5pt}\vspace{0.2em}\Huge\bfseries\color{redesdark}}
\posttitle{\par\end{flushleft}\vspace{0.4em}}
\preauthor{\begin{flushleft}\large\color{redesneutral}}
\postauthor{\par\end{flushleft}}
\predate{\begin{flushleft}\small\color{redesneutral}}
\postdate{\par\end{flushleft}\vspace{0.2em}\color{redesteal}\rule{\linewidth}{0.5pt}}
...
\title{Ten Ways to Use Agentic AI in Academic Research}
\author{REDES-IA \textemdash{} Herramientas de IA para ciencias sociales}
\date{}
